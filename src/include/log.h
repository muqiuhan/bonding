...
#define LOG_INFO(msg) simplog.writeLog (SIMPLOG_INFO, msg)
#define LOG_DEBUG(msg) simplog.writeLog (SIMPLOG_DEBUG, msg)
#define LOG_WARN(msg) simplog.writeLog (SIMPLOG_WARN, msg)
#define LOG_ERROR(msg) simplog.writeLog (SIMPLOG_ERROR, msg)
