...
TEST_CASE("structopt can parse stack positional argument"
          * test_suite("stack_positional"))
{
  // List of ints
  {
...
TEST_CASE("structopt can parse queue positional argument"
          * test_suite("queue_positional"))
{
  // List of ints
  {
...
TEST_CASE("structopt can parse priority_queue positional argument"
